...
const Doghouse = () => {
  ...
  const dogs: Dog[] = [
    ...
    },
    {
      ...
      description: '',
      category: 'tech',
      story: "Disrupting the status quo with their quiet innovation and unconventional strategies. Doesn't bark about their success - just lets their effective financial moves do the talking. Always hustling for the next big thing in the market.",
    },
    {
      name: 'Basset Hound',
    ...
    },
    {
      ...
      story: "Demands to speak to every manager in a five-mile radius about their service fees. Has strong opinions about everything and isn't afraid to share them loudly. Will absolutely write a strongly worded email about that 2-cent fee and post a scathing review.",
    },
    {
    ...
    },
    {
      ...
      description: '',
      category: 'personality',
      story: "Always ready with a joke and a goofy grin to brighten up boring budget talks. Whether it's dad jokes during meetings or practical pranks in the office, they keep the mood light while still getting the job done. Watch for whoopee cushions!",
    },
    {
      name: 'Bullmastiff',
      title: 'The Rapper',
      description: '',
      category: 'creative',
      story: "Dropping hot financial bars and sick money beats with that signature flow. Every budget review turns into a freestyle session, and quarterly reports come in rhyme form. They've got mad skills when it comes to making your portfolio grow, yo!",
    },
    {
      name: 'Chihuahua',
      title: 'The Rager',
      description: '',
      category: 'personality',
      story: "Zero chill, maximum attitude, and ready to throw down over every market fluctuation. Flies off the handle at the smallest dip and barks furiously at every suspicious transaction. Small package, nuclear-level reactions. Just don't call them cute!",
    },
    {
      name: 'Chow Chow',
      title: 'The Grump',
    ...
    },
    {
      ...
      description: '',
      category: 'creative',
      story: "Living that content creator life with perfect lighting and curated aesthetics. Every financial tip comes with a sponsored post, promo code, and perfect camera angle. Don't forget to like, subscribe, and smash that investment button!",
    },
    {
      name: 'Dachshund',
      title: 'The Detective',
    ...
    },
    {
      ...
      description: '',
      category: 'professional',
      story: "Always first on the scene when your finances are burning down, sirens blazing. Rushes in to extinguish money emergencies and rescue your budget from disaster with practiced precision. Cool under pressure, hot on response time, ready to save.",
    },
    {
      name: 'Doberman',
      ...
      description: '',
      category: 'professional',
      story: "Takes your financial security dead serious, with military-grade protection protocols. Always scanning for threats and running safety checks with unwavering focus. They've got eyes everywhere and a sixth sense for scams. Your money's safe on their watch.",
    },
    {
      ...
      description: '',
      category: 'lifestyle',
      story: "Keeps things caveman simple with prehistoric wisdom. No fancy charts or big words - just straightforward financial advice that even a prehistoric pup could follow. Grunt once for save, grunt twice for invest, three times for diversify portfolio.",
    },
    {
      name: 'French Bulldog',
      title: 'The Hipster',
      description: '',
      category: 'lifestyle',
      story: "Only invests in obscure startups you've never heard of while sipping artisanal, ethically sourced coffee. Tracks expenses in a vintage leather journal using a hand-carved fountain pen. Probably had that investment strategy before it was cool.",
    },
    {
      ...
      description: '',
      category: 'professional',
      story: "Standing at attention with military precision, this disciplined pup runs finances like a well-oiled machine. With tactical planning and unwavering dedication, they'll march your budget through any battlefield toward financial victory.",
    },
    {
    ...
    },
    {
      ...
      description: '',
      category: 'lifestyle',
      story: "Treating your portfolio like it's leg day - no skipping, no excuses, maximum gains only. Always ready to spot you through tough investments and celebrate with protein shakes. Do you even compound interest, bro? Let's get those financial gains!",
    },
    {
      name: 'Greyhound',
      title: 'The Gamer',
    ...
    },
    {
      ...
      description: '',
      category: 'personality',
      story: "Don't let the tough look fool you - this gentle powerhouse brings both strength and heart to your financial journey. Protecting your interests while keeping that soft spot for smart money moves.",
    },
    {
      name: 'Pomeranian',
    ...
    },
    {
      ...
      description: '',
      category: 'professional',
      story: "Always ready with emergency snacks and budget band-aids, this nurturing pup keeps your finances warm and cozy. Between packing your lunch to save money and reminding you to wear a jacket because the market is cold, they've got your back like only a mom can.",
    },
    {
      name: 'Saluki',
      title: 'The Mystic',
