            ...
            <section id="platform-expansion" className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <p className="text-gray-600 mb-2">Cardano marketplace with job listings and project funding campaigns</p>
                  <div className="mt-3 px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl shadow-md">
                    <p className="text-white text-sm font-semibold">Live & Operational</p>
                    <p className="text-blue-100 text-xs">Continuous feature updates</p>
                  </div>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                ...
                >
                  ...
                  <div className="mt-3 px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl shadow-md">
                    <p className="text-white text-sm font-semibold">Live & Operational</p>
                    <p className="text-blue-100 text-xs">Ongoing improvements</p>
                  </div>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 50 }}
                ...
                >
                  ...
                  <p className="text-gray-500 font-medium mb-4">In Development</p>
                  <p className="text-gray-600 mb-2">Marketing voice and insights pup for the community</p>
                  <div className="mt-3 px-4 py-3 bg-gradient-to-r from-gray-400 to-gray-500 rounded-xl shadow-md">
                    <p className="text-white text-sm font-semibold">Q2-Q4 2025</p>
                    <p className="text-gray-100 text-xs">Active development after BoneBoard launch</p>
                  </div>
                </motion.div>
              </div>
            </section>
