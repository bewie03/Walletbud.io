    ...
    <div className="min-h-screen bg-blue-900 py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center transform hover:scale-[1.02] transition-transform duration-300">
          <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl animate-fade hover:scale-105 transition-transform duration-300">
            $BONE
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-full">
            ...
            <div className="bg-blue-900 rounded-lg p-8 border border-blue-700 transform hover:shadow-xl transition-all duration-300 h-full flex flex-col">
              ...
              <h2 className="text-2xl font-bold text-white mb-6 hover:scale-105 transition-transform duration-300">How Our Token System Works</h2>
              
              {/* Fair Entry Section */}
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-blue-100 mb-3 hover:scale-105 transition-transform duration-300">Fair Entry for Everyone</h3>
              ...
              {/* Example Section */}
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-blue-100 mb-3 hover:scale-105 transition-transform duration-300">How Token Distribution Works</h3>
                <div className="bg-blue-800/50 p-4 rounded-lg hover:scale-105 transition-transform duration-300">
                  <div className="mb-4">
                    <p className="text-white font-semibold mb-2 hover:scale-105 transition-transform duration-300">Early Users:</p>
                    <p className="text-blue-100 ml-4 hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="mb-4">
                    <p className="text-white font-semibold mb-2 hover:scale-105 transition-transform duration-300">As Market Grows:</p>
                    <p className="text-blue-100 ml-4 hover:scale-105 transition-transform duration-300">
                  ...
                  <div>
                    <p className="text-white font-semibold mb-2 hover:scale-105 transition-transform duration-300">Benefits For Everyone:</p>
                    <p className="text-blue-100 ml-4 hover:scale-105 transition-transform duration-300">
              ...
              <div>
                <h3 className="text-xl font-semibold text-blue-100 mb-3 hover:scale-105 transition-transform duration-300">Token Requirement System</h3>
                <div className="grid grid-cols-1 gap-4">
                  <div className="bg-blue-800/50 p-4 rounded-lg mb-6">
                    <p className="text-blue-100 mb-4 hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-blue-100">
                      <div>
                        <p className="mb-2 hover:scale-105 transition-transform duration-300">Early Stage:</p>
                        <ul className="list-disc pl-4 space-y-1">
                          <li className="hover:scale-[1.02] transition-transform duration-300">$1M MCAP: 20,000 $BONE</li>
                          <li className="hover:scale-[1.02] transition-transform duration-300">$2M MCAP: 10,000 $BONE</li>
                          <li className="hover:scale-[1.02] transition-transform duration-300">$5M MCAP: 4,000 $BONE</li>
                          <li className="hover:scale-[1.02] transition-transform duration-300">$10M MCAP: 2,000 $BONE</li>
                          <li className="hover:scale-[1.02] transition-transform duration-300">$15M MCAP: 1,300 $BONE</li>
                        </ul>
                      </div>
                      <div>
                        <p className="mb-2 hover:scale-105 transition-transform duration-300">Growth Stage:</p>
                        <ul className="list-disc pl-4 space-y-1">
                          <li className="hover:scale-[1.02] transition-transform duration-300">$20M MCAP: 1,000 $BONE</li>
                          <li className="hover:scale-[1.02] transition-transform duration-300">$30M MCAP: 650 $BONE</li>
                          <li className="hover:scale-[1.02] transition-transform duration-300">$50M MCAP: 400 $BONE</li>
                          <li className="hover:scale-[1.02] transition-transform duration-300">$75M MCAP: 265 $BONE</li>
                          <li className="hover:scale-[1.02] transition-transform duration-300">$100M MCAP: 200 $BONE</li>
                        </ul>
                      </div>
                    </div>
                  </div>
            ...
            <div>
              ...
              <AnimatedElement animation="slideLeft" delay={0.4}>
                <div className="bg-blue-900 rounded-lg p-6 border border-blue-700 transform hover:shadow-xl transition-all duration-300">
                  <h3 className="text-xl font-bold text-white mb-3 hover:scale-105 transition-transform duration-300">Token Details</h3>
                  <div className="space-y-3">
                    ...
                    <AnimatedElement animation="fadeIn" delay={1}>
                      <div className="mt-4">
                        <h4 className="text-md font-semibold text-white mb-2 hover:scale-105 transition-transform duration-300">Token Distribution</h4>
                        <div className="space-y-2">
                          <div>
                            <div className="flex justify-between text-blue-100 mb-1 hover:scale-105 transition-transform duration-300">
                            ...
                            <p className="text-xs text-blue-200 mt-0.5 hover:scale-105 transition-transform duration-300">950,000,000 $BONE</p>
                          </div>
                          ...
                          <div>
                            ...
                            <p className="text-xs text-blue-200 mt-0.5 hover:scale-105 transition-transform duration-300">50,000,000 $BONE</p>
                          </div>
                        </div>
                      </div>
                    </AnimatedElement>
                    ...
                    <AnimatedElement animation="fadeIn" delay={1}>
                      <p className="text-sm text-blue-100 mt-3 hover:scale-105 transition-transform duration-300">
              ...
              <AnimatedElement animation="slideLeft" delay={0.6}>
                <div className="bg-blue-900 rounded-lg p-8 border border-blue-700 transform hover:shadow-xl transition-all duration-300 mt-8">
                  <h3 className="text-xl font-bold text-white mb-4 hover:scale-105 transition-transform duration-300">One-Way Token Requirement System</h3>
